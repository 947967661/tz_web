  ...
  computed: {
      ...
      return [
        {
          ...
          value: this.common.precision_basic(this.report.yongjin_sum)
        },
        {
          key: "revenueToday",
          label: this.$t('team.revenueToday'),
          value: this.common.precision_basic(this.report.yongjin_sum_to)
        },
        {
          key: "yesterday",
          label: this.$t('team.yesterday'),
          value: this.common.precision_basic(this.report.yongjin_sum_ye)
        },
        {
          key: "teamSize",
          label: this.$t('team.teamSize'),
          value: this.report.team_size
        }
      ];
    },
    platformMoneySymbol() {
    ...
    bonusDisplayRows() {
      return [
        {
          key: "bonus_line_1",
          text: this.translate("team.bonus_line_1", "一级首投奖励 ", "Team Level 1 First Investment Bonus ")+this.report.level_1_rate+"%"
        },
        {
          key: "bonus_line_2",
          text: this.translate("team.bonus_line_2", "二级首投奖励 ", "Team Level 2 First Investment Bonus ")+this.report.level_2_rate+"%"
        },
        {
          key: "bonus_line_3",
          text: this.translate("team.bonus_line_3", "三级首投奖励 ", "Team Level 3 First Investment Bonus ")+this.report.level_3_rate+"%"
        }
      ];
    }
  },
